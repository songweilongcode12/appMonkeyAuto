...
if aw == 'y':
    ...
    for i in range(n):
        ...
        if pk == 'com.quvideo.slideplus':
            ...
            if filedir:
                logger.info("File Exist,go on testing!")
            else:
            ...
            logger.info("待测手机" + name + '-' + model + "未安装小影记")
